        ...
        <div ref={containerRef} style={{ position: 'relative', width: '100%' }}>
            ...
            >
                {items.map((item) => (
                    ...
                    >
                        {/* Background Image */}
                        <div className="work-image-wrapper" style={{ width: '100%', height: '100%', position: 'absolute' }}>
                            <img
                                src={item.image}
                                alt={item.title}
                        ...
                        >
                            ...
                            {item.video && (
                                ...
                                >
                                    ...
                                    <img src={item.video} style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                                </div>
                            )}
                            ...
                            >
                                ...
                                {item.description && (
                                    <p style={{ fontSize: '1.25rem', opacity: 0.8, maxWidth: '600px', margin: item.video ? '0' : '0 auto' }}>
                                        {item.description}
                                    </p>
                                )}

                                {item.metadata && (
                                    <div style={{ marginTop: '3rem', display: 'flex', gap: '3rem', justifyContent: item.video ? 'flex-start' : 'center' }}>
                                        {item.metadata.map((meta, i) => (
                                            <div key={i}>
                                                <div style={{ fontSize: '0.875rem', opacity: 0.6, textTransform: 'uppercase', marginBottom: '0.5rem' }}>{meta.label}</div>
