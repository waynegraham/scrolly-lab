                ...
                imgs.forEach((_, index) => {
                    ...
                    if (nextImage) {
                        ...
                        sectionTimeline
                            ...
                            .to(container, { backgroundColor: bgColors[index + 1] || bgColors[index], duration: 1.5, ease: 'power2.inOut' }, 0)
                            // Wipe current image up (inset bottom goes to 100%)
                            .to(currentImage, { clipPath: 'inset(0px 0px 100% 0px)', objectPosition: '0px 60%', duration: 1.5, ease: 'none' }, 0)
            ...
            mm.add('(max-width: 768px)', () => {
                ...
                imgs.forEach((image, index) => {
                    ...
                    innerTimeline
                        ...
                        .to(container, { backgroundColor: bgColors[index], duration: 1.5, ease: 'power2.inOut' }, 0);
                    ...
                    {items.map((item) => (
                        ...
                        >
                            <div style={{ maxWidth: '360px' }}>
                                <h2 style={{ fontSize: '42px', fontWeight: 800, margin: 0, letterSpacing: '-0.8px' }}>{item.title}</h2>
                                <p style={{ fontSize: '18px', opacity: 0.8, margin: '16px 0 28px', lineHeight: 1.5 }}>{item.description}</p>
                                {item.linkText && (
                                    <a
                                        href={item.linkUrl || '#'}
                                        style={{
