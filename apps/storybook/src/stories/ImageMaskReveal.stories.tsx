...
const ITEMS = [
  ...
  },
  {
    ...
    description:
      'Desert refuge with fluid architecture and glowing interiors. This sanctuary harnesses solar power, sustainable design, and natural harmony.',
    image:
  ...
  },
  {
    ...
    description:
      'Ethereal structures arc over tranquil waters, bathed in the glow of a setting Martian sun. This desolate beauty showcases the stark landscapes.',
    image:
    ...
    items: [
      {
        ...
        title: 'واحة خضراء',
        description:
          'شوارع نابضة بالحياة مع حدائق عمودية ومباني شمسية. تزدهر هذه الواحة بالطاقة المتجددة والنقل الذكي.',
        image: ITEMS[0].image,
        backgroundColor: '#EDF9FF',
        accentColor: '#D5FF37',
      ...
      },
      {
        ...
        description:
          'ملاذ صحراوي يتميز بهندسة معمارية سائلة وتصميمات داخلية متوهجة. يستغل هذا الملاذ الطاقة الشمسية والتصميم المستدام.',
        image: ITEMS[2].image,
        backgroundColor: '#FFECF2',
        accentColor: '#FFA0B0',
        linkText: 'اكتشف',
