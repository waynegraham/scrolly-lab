  ...
  return (
    <main>
      ...
      <section style={{ height: '100vh', position: 'relative' }}>
        <ParallaxHero backgroundImage="/images/1.jpg" speed={0.5}>
          <div
            style={{ textAlign: 'center', color: '#fff', textShadow: '0 2px 10px rgba(0,0,0,0.5)' }}
          >
            <h1 style={{ fontSize: 'clamp(3rem, 8vw, 6rem)', margin: 0, fontWeight: 800 }}>
              Scrolly Showcase
            </h1>
      ...
      <div style={{ padding: '4rem 2rem', background: '#111', color: '#fff', textAlign: 'center' }}>
        ...
        <p style={{ maxWidth: '600px', margin: '0 auto', fontSize: '1.25rem', opacity: 0.8 }}>
          Scroll down to experience the pinned reveals, 3D carousels, and stacked card effects built
          with GSAP and React Three Fiber.
        </p>
      </div>
          ...
          items={[
            {
              ...
              description:
                'Clean lines and geometric harmony define this architectural masterpiece.',
              image: '/images/1.jpg',
